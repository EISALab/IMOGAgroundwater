subroutine Obj_Func_Coarse (Total_cost, gridflagx, gridflagy)
!*********************************************************************
...
! directly from buffers HEADfrmMODF and CONCfrmMT3D respectively.
	 ...
	 integer, intent(in) :: gridflagx, gridflagy
      ...
      real :: Delr(Ncol1), Delc(Nrow1),OriDelr(OriNcol1), OriDelc(OriNrow1),&
             ...
             & CRdx(Nrow1,Ncol1,MxYr1), CTnt(Nrow1,Ncol1,MxYr1),&
...
! some changed will have to be made to the input file as well.
	...
	!do i2 = 1,iter
	HEADfrmMODF = 0.00d0
	call modflow_sub(namefile, HEADfrmMODF, Ncol1, Nrow1, Nstress)
	CONCfrmMT3D = 0.00d0
