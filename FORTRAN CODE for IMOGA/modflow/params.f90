...
!     Added by Eva Sinha on Dec, 02, 2002
     ...
     integer :: nsga_type = 2
	 ! if nsga_type = 1, use nsga, if equal to 2, use nsga_II
	 ...
	 integer :: distance_type = 3
  !1 for phenotypic over parameter space, 0 for Hamming, 3 for phenotypic over function values
  !dont use 0
