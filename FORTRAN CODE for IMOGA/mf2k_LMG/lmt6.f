...
c     &      ACTION=ACTION(2),STATUS='REPLACE')
     &      STATUS='REPLACE')
        ELSEIF(ILMTFMT.EQ.1) THEN
c          OPEN(IMT3D,FILE=FNAME,FORM='FORMATTED',ACTION=ACTION(2),
          OPEN(IMT3D,FILE=FNAME,FORM='FORMATTED',
c     &      STATUS='REPLACE',DELIM='APOSTROPHE')
     &      STATUS='REPLACE')
        ENDIF
      ENDIF
C
