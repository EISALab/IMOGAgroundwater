...
c
      ...
      read(lin,*,err=98) vmin,vmax
      write(*,*) ' vertical trimming limits = ',vmin,vmax
...
c     write(*,*) var(4),vmin,vmax
      if(var(4).lt.vmin.or.var(4).gt.vmax)then
      go to 2
      endif
c      write(*,*) "valid data"
      testdat = .false.
...
c
c The above is for Illinois EPA, allows specifying depth intervals
c for determining variograms (i.e., must specify vmin and vmax for 
c vertical depth min and max to classify appropriate depth interval)
c
c
