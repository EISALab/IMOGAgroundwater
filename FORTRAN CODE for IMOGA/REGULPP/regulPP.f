...
c
 ...
 1234 format('gen',i4)
	...
	do i = 1, num
	    ...
	    read(2345, *)
	    read(2345, *)
		call writeout(inp, regul, numd, idnum)
	    write(3456, *) regul
	end do
c	call writeout
c
...
c
 ...
 9998 format(/' GAMV Version: ',f5.3, ' Finished'/)
      ...
      subroutine readparm(numd, idnum)
c-----------------------------------------------------------------------
c
...
c
 ...
 7    continue
      ...
      subroutine writeout(inp, regul,numd, idnum)
c-----------------------------------------------------------------------
c
...
c            do il=1,nlag+2
	  ...
	  do j = numd+1,nd
	    ...
	    val1 = vr(i,1)
	    val2 = vr(j,1)
	    if(idnum(i).lt.0) val1 = inp(14+i-numd)
	    if(idnum(j).lt.0) val2 = inp(14+j-numd)
	    diff = val1 - val2
	    diff = diff**2
