...
public class ProduceCounts extends ncsa.d2k.core.modules.OutputModule implements DataProducer {

    CountsTransferable transf = null;
    ...
    public String getInputInfo(int index) {
        switch (index) {
            case 0 :
                return "<p>These are the results of the ClustalW program.</p>";
            default :
    ...
    public String getModuleInfo() {
        return "<p>Overview: Produce counts fror ClustalW program as HTML.</p>";
    }
    ...
    public String getModuleName() {
        return "Produce ClustalW Counts";
    }
    boolean debug = true;
    ...
    protected void doit() throws Exception {
        ...
        transf = new CountsTransferable(cwr);
        if (debug) {
     ...
     * @author redman
     */
    class CountsTransferable implements Transferable, Serializable {
        ...
        CountsTransferable(ClustalWResults cawr) throws ClassNotFoundException {
            cwr = cawr;
