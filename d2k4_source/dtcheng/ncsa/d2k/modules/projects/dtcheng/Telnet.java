...
public class Telnet extends ComputeModule
  {
  ...
  //private String TelnetCommandString  = "C:\\Program Files\\NCSA\\Kerberos 5\\telnet.exe";
  private String TelnetCommandString  = "C:\\cygwin\\bin\\telnet.exe";
  public  void   setTelnetCommandString (String value)  {       this.TelnetCommandString       = value;}
  public  String getTelnetCommandString ()              {return this.TelnetCommandString;}
  ...
  void wait (int time) throws Exception
    ...
    try
      ...
      {
      System.out.println("wait error!!!"); throw e;
      }
    }
  ...
  public void doit() throws Exception
    ...
    if (numCommands > 0)
      {
      String command = TelnetCommandString + " " + machineName;
