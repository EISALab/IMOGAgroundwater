...
public class ProduceAlignments extends ncsa.d2k.core.modules.OutputModule implements DataProducer {

	AlignmentTransferable transf = null;
	...
	public String getModuleInfo() {
		return "<p>Overview: Produce alignments from ClustalW program as HTML.</p>";
	}
	...
	public String getModuleName() {
		return "Produce ClustalW Alignments";
	}
	boolean debug = true;
	...
	protected void doit() throws Exception {
		...
		transf = new AlignmentTransferable (cwr);
		if (debug) {
	 ...
	 * @author redman
	 */
	class AlignmentTransferable implements Transferable, Serializable {
		...
		AlignmentTransferable (ClustalWResults cawr) throws ClassNotFoundException {
			cwr = cawr;
