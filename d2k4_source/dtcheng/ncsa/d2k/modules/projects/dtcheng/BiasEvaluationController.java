      ...
      case 1:
        ...
        if ((ExampleSetIndex - UtilityIndex < BatchSize) && (ExampleSetIndex < NumRepetitions)) {
          ...
          if (!TimeSeriesMode) {
            ...
            for (int e = 0; e < NumTrainExamples; e++) {
              trainSetIndicies[e] = ExampleIndex++;
            }
            for (int e = 0; e < NumTestExamples; e++) {
              testSetIndicies[e] = ExampleIndex++;
            }
          }
      ...
      case 2:
        ...
        if (UtilityIndex == NumRepetitions) {
          ...
          ParameterPoint meanObjectivePoint =
              ncsa.d2k.modules.core.datatype.parameter.impl.ParameterPointImpl.getParameterPoint(names, meanUtilityArray);
