...
public class ProduceSummary extends ncsa.d2k.core.modules.OutputModule implements DataProducer {

	SummaryTransferable transf = null;
	...
	public String getModuleInfo() {
		return "<p>Overview: Produce summary fror ClustalW program as HTML.</p>";
	}
	...
	public String getModuleName() {
		return "Produce ClustalW Summary";
	}
	boolean debug = true;
	...
	protected void doit() throws Exception {
		...
		transf = new SummaryTransferable (cwr);
		if (debug) {
	 ...
	 * @author redman
	 */
	class SummaryTransferable implements Transferable, Serializable {
		...
		SummaryTransferable (ClustalWResults cawr) throws ClassNotFoundException {
			cwr = cawr;
