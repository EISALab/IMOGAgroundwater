...
public class FTPPutFile extends InputModule {
  ...
  public void doit() throws Exception {
    ...
    String localFileName = (String)this.pullInput(1);
    String remoteFileName = (String)this.pullInput(2);
