...
public class ReadLineByteStream
    extends InputModule {
  ...
  public void doit() throws Exception {
    ...
    if ( ( (StartLineIndex == -1) || ( (LineIndex >= StartLineIndex))) && ( (EndLineIndex == -1) || (LineIndex <= EndLineIndex))) {
      if (Trace && (LineIndex % ReportInterval == 0))
        System.out.println("line " + LineIndex + " = " + new String(Input.Buffer, Input.LineStart, (Input.LineEnd - Input.LineStart - 1)));
