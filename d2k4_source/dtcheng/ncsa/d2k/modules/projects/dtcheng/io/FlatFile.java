...
public class FlatFile
  ...
  public int EOLNumBytes = 1;
  public byte EOLByte1 = 10; // new line = 10 (unix) !!!
  public byte EOLByte2 = 10; // 10 (unix) 13 (mac)!!!
  ...
  public void readLine() throws Exception {
    ...
    while (true) {
      ...
      if (Buffer[localByteIndex++] == localEOLByte1) {
    ...
    if (EOLNumBytes == 2) {
      if (Buffer[localByteIndex] != EOLByte2) {
        System.out.println("Error!  Buffer[localByteIndex] ("+ Buffer[localByteIndex] +") != localEOLByte2");
      }
      localByteIndex++;
    }
