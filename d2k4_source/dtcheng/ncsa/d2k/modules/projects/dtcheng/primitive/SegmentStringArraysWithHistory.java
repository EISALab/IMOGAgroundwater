...
public class SegmentStringArraysWithHistory
    extends ComputeModule {

  public String getModuleName() {
    return "SegmentStringArraysWithHistory";
  }

  public String getModuleInfo() {
    return "This module segments a 1d string arrays into two pieces.  " +
  ...
  public void doit() {
    ...
    String[] array = (String[])this.pullInput(0);
    ...
    String[] array1 = new String[array1NumValues];
    String[] array2 = new String[array2NumValues];
