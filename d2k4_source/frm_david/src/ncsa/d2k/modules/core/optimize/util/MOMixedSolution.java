...
/**
	This subclass of MixedSolution allows for multiple objective
	values.
*/
public class MOMixedSolution extends MixedSolution implements MOSolution, java.io.Serializable {
	 ...
	 */
	public MOMixedSolution (Range [] ranges, ObjectiveConstraints [] oc) {
		super (ranges);
	...
	*/
	...
	public Object clone(){
		...
		MOMixedSolution newSol=new MOMixedSolution(newRanges, newOcs);
