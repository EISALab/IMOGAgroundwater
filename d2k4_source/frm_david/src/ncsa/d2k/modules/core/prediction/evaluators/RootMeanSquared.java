...
public class RootMeanSquared extends ncsa.d2k.core.modules.ComputeModule
{
	...
	*/
	...
	public boolean isReady(){
		...
		if((!crossValidate)&&(getInputPipeSize(0)>0)){
			return true;
		}
		if(crossValidate&&(tts!=null)&&(getInputPipeSize(0)>0)){
			return true;
		}
	...
	protected void untransformTable(ExampleTable tt){
		List transforms=((ExampleTable)tt).getTransformations();
	...
	*/
	public void doit () throws Exception{
		...
		if (table instanceof TestTable) {
			...
			tts [n-1] = ((ExampleTable)table).toPredictionTable();
		}
