 ...
 * Window>Preferences>Java>Code Generation>Code and Comments
 */
public class SparseStringObjectColumnTest extends AbstractColumnTest {

	/**
	 * Constructor for StringColumnTest.
	 * @param arg0
	 */
	public SparseStringObjectColumnTest(String arg0) {
		super(arg0);
	}

	public static void main(String[] args) {
		junit.textui.TestRunner.run(SparseStringObjectColumnTest.class);
	}
	...
	public Column getFullColumn() {
		...
		Column cFull = new SparseStringObjectColumn(values);
		return cFull;
	}

	public Column getEmptyColumn() {
		Column cEmpty = new SparseStringObjectColumn();
		return cEmpty;
