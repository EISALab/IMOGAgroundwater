 ...
 * Window>Preferences>Java>Code Generation>Code and Comments
 */
public class ContinuousStringColumnTest extends AbstractTextualColumnTest {

	/**
	 * Constructor for ContinuousStringColumnTest.
	 * @param arg0
	 */
	public ContinuousStringColumnTest(String arg0) {
		super(arg0);
	}

	public static void main(String[] args) {
		junit.textui.TestRunner.run(ContinuousStringColumnTest.class);
	}
	...
	public Column getFullColumn() {
		...
		Column cFull = new ContinuousStringColumn(values);
		return cFull;
	}

	public Column getEmptyColumn() {
		Column cEmpty = new ContinuousStringColumn();
		return cEmpty;
