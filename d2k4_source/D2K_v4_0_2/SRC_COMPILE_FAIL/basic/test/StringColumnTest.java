 ...
 * Window>Preferences>Java>Code Generation>Code and Comments
 */
public class StringColumnTest extends AbstractTextualColumnTest {

	/**
	 * Constructor for StringColumnTest.
	 * @param arg0
	 */
	public StringColumnTest(String arg0) {
		super(arg0);
	}

	public static void main(String[] args) {
		junit.textui.TestRunner.run(StringColumnTest.class);
	}
	...
	public Column getFullColumn() {
		...
		Column cFull = new StringColumn(values);
		return cFull;
	}

	public Column getEmptyColumn() {
		Column cEmpty = new StringColumn();
		return cEmpty;
