 ...
 * values for the Coverage Clustering Algorithm.
 * </p>
...
public class CoverageParamSpaceGenerator extends AbstractParamSpaceGenerator {
  ...
  public static final String COV_DIST_THRESH = "Coverage Distance Threshold";
  public static final String COV_MAX_NUM_SAMPLES = "Coverage Max Num Samples";
  ...
  public PropertyDescription[] getPropertiesDescriptions() {
    ...
    pds[4] = new PropertyDescription(COV_DIST_THRESH,
                                     ...
                                     "is approximated by taking the min and max of each attribute and forming a " +
                                     "min example and a max example -- then finding the distance between the two.");
    pds[5] = new PropertyDescription(COV_MAX_NUM_SAMPLES,
