...
public class NewSQLRainForestOPT extends ReentrantComputeModule {
  ...
  */
  ...
  public String getInputInfo (int i) {
      ...
      switch (i) {
        ...
        case 4: return "The parameters used in this module.";
  ...
  public String getModuleInfo () {
    ...
    s += "There are two implementations on RainForest. <i>NewSQLRainForestOPT</i> does ";

    s += "not do parameter optimization, but <i>NewSQLRainForestOPTOPT<i> does.</p>";
  ...
  public void doit() throws Exception {
    ...
    ParameterPoint pp = (ParameterPoint)pullInput(4);
