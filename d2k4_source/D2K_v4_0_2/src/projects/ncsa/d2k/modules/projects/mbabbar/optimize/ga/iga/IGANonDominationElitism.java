...
*/
public class IGANonDominationElitism extends ncsa.d2k.core.modules.ComputeModule
			 {
	...
	*/
	...
	public String[] getInputTypes () {
		String[] types = {"ncsa.d2k.modules.core.optimize.ga.IGANsgaPopulation"};
		return types;
	}
	...
	*/
	public void doit () {
		IGANsgaPopulation population = (IGANsgaPopulation) this.pullInput (0);
                //for(int i = 0; i < population.getCombinedPopulation().length ;i++){
                //System.out.println(i+"Ranked Flag"+population.getCombinedPopulation()[i].getRankedIndivFlag());
                //}
		...
		if ((population.getCurrentGeneration () > 0)&&(!population.restart)) {
			...
			for (int i = 0 ; newPopSize < sz ; i++) {
				...
				population.computeCrowdingDistanceGeneAndObj(currentFront, frontSize);
			...
			// of these members.
               ...
               //System.out.println(i+"Ranked Flag"+((IGANsgaSolution)population.getMember(i)).getRankedIndivFlag());
               //}
