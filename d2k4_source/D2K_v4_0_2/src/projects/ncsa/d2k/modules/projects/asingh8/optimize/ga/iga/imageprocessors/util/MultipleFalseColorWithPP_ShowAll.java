...
public class MultipleFalseColorWithPP_ShowAll extends DataPrepModule implements java.io.Serializable {
	...
	*/
	public void doit() throws Exception{
		...
		//int[] selectedWells = (int[])pullInput(2);
                ...
                while(interpFilenamesTable == null){
                    interpFilenamesTable = (Table)pullInput(2);
                }
                ...
                */
                ...
                if(interpFilenamesTable.getNumRows()>0) {
                fcPanelTitle = new String [interpFilenamesTable.getNumRows()][interpFilenamesTable.getNumColumns()];
                geneFCIds = new int [interpFilenamesTable.getNumRows()];
                }
                ...
                if(interpFilenamesTable.getNumRows()>0){
                 falseColPan = new FalseColorPanel [interpFilenamesTable.getNumRows()][interpFilenamesTable.getNumColumns()];
                }
                // looping over all the designs
                for (int i=0; i< interpFilenamesTable.getNumRows(); i++) {
                    ...
                    for (int k=0; k < interpFilenamesTable.getNumColumns(); k++){
                          ...
                          falseColPan [i][k] = new FalseColorPanel(interpTable, wells);
                          falseColPan [i][k].imagePanel.setZoom(4.25);
                          //, wells, selectedWells);
                        }
                }
