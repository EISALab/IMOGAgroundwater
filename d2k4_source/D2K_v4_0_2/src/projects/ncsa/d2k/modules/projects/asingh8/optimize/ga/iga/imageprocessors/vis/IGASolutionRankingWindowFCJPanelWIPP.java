 ...
 */
public class IGASolutionRankingWindowFCJPanelWIPP extends UIModule {
    ...
    public double userImgMin1,userImgMin2, userImgMin3, userImgMax1,userImgMax2,userImgMax3 ;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   public UserView createUserView() {
      //this.setModuleName("IGA: Solutions Ranking Section");
   ...
   public double getUserImageMin3 (){
      return userImgMin3;
   }
   ...
   public double getUserImageMax3 (){
      return userImgMax3;
   }
   ...
   public void setUserImageMin1 (double d){
     ...
     public void setUserImageMin3 (double d){
      userImgMin3 = d;
  }
   ...
   public void setUserImageMax1 (double d){
      ...
      userImgMax2 = d;
       ...
       public void setUserImageMax3 (double d){
      userImgMax3 = d;
  }
   ...
   public void stModuleName(String name){
       moduleName = name;
   }
...
////////////////////////////////////////////////////////////////////////////////
   ...
   public class IGARankingView extends JUserPane implements ActionListener   {
     ...
     // protected Table table = null;
      ...
      protected IGASolutionRankingWindowFCJPanelWIPP parent;
      /** Back button */
      ...
      public void initView(ViewModule mod) {
        ...
        parent = (IGASolutionRankingWindowFCJPanelWIPP)mod;
        parent.stModuleName("IGA: Solutions Ranking - Generation "+currentPop.getCurrentGeneration());                
              ...
              */
                ...
                for (int i =0; i<4; i++){
                    ...
                    // add pictures to a grid panel
                      ...
                      picgridTitlePanel.setPreferredSize(new Dimension(120,30));

                      picgridTitlePanel.setLayout(new GridLayout(3,3));
                     ...
                     ////////////////////////////////////////////////////////////////////
                      //for (int j=0; j< panelInTitle[0].length; j++){
                           ...
                           picgridTitlePanel.add(new JLabel("Log K Field "+(picIndivIds[counter])));
                           picgridTitlePanel.add(new JLabel("H Err "+(picIndivIds[counter])));
                           picgridTitlePanel.add(new JLabel("H Field "+(picIndivIds[counter])));
                        ...
                        for (int j = 0;j<currentPop.getNumObjectives()-1;j++){
                          ...
                          //picgridTitlePanel.add(new JLabel(" "));
                           ...
                           picgridTitlePanel.add(new JLabel(ObjTitles[currentPop.getNumObjectives()-1]));
                      ...
                      for (int j=0; j< panelIn[0].length; j++){
                          ...
                          if(j == 2){
                          fc.setUserImageMax(userImgMax3);
                          fc.setUserImageMin(userImgMin3);
                          }
                      ...
                      picAndTitleGridPanel.setPreferredSize(new Dimension(700,250));
                      
                      Dimension dp2 = new Dimension (picAndTitleGridPanel.getPreferredSize());
                      
                      System.out.println ("dp2 Height : " + dp2.getHeight() + "dp2 Width : " + dp2.getWidth());
