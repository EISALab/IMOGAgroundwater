package ncsa.d2k.modules.projects.asingh8.optimize.ga.iga.vis;
 ...
 */
public class IMOGAClosingWindow extends UIModule {
...
////////////////////////////////////////////////////////////////////////////////
   ...
   public String getOutputName(int i) {
      if (i == 0)
         return "Continued Multiobjective IGA NSGA Population";
      if (i == 1)
          return "Finished Multiobjective IGA NSGA Population";
      return "No such output";
   }
...
////////////////////////////////////////////////////////////////////////////////
    ...
    */
   public class IMOGAClosingView extends JUserPane implements ActionListener {

      /** a reference to our parent module */
      protected IMOGAClosingWindow parent;
      /** Next button */
      protected JButton next;
      /** Quit button */
      protected JButton quit;
      
      protected JButton vis;
      ...
      public void initView(ViewModule mod) {
         parent = (IMOGAClosingWindow)mod;
            ...
            vis = new JButton("See Last Gen");
            vis.setEnabled(true);
            vis.addActionListener(new AbstractAction() {
              public void actionPerformed(ActionEvent e) {
                  //currentPop.isDone();
                pushOutput(currentPop, 1);
                viewDone("Done");
            ...
            next = new JButton("Continue IMOGA");
