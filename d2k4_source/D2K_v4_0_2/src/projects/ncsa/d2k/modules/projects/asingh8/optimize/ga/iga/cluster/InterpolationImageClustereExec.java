...
public class InterpolationImageClustereExec extends ncsa.d2k.core.modules.ComputeModule{
        ...
        int[] execFitnessIds ;
        int[] numOutputFiles;
        String execName = new String("myNcut");
	...
	*/
	...
	public int getNoMaxClusters(){
		return noMaxClusters;
	}
        
	public void setNoMaxClusters(int i){
		noMaxClusters=i;
	}
		...
		return "<html>  <head>      </head>  <body>    Interpolate & Cluster this population using a clustering executable.  </body></html>";
	}
	...
	public String getInputInfo(int index) {
		switch (index) {
			...
			case 1: return "IGA Table";
                        case 2: return "A TableImpl data structure that contains the chromosomes that need to be evaluated by the interpolation program.";
			case 3: return "A TableImpl data structure that contains fitness ids for fitnesses evaluated using the executables and the entire paths names for executables with runtime arguments.";
	...
	*/
       public void doit () throws Exception {
          ...
          //  System.out.println("entering doit function of EvaluateExecutableFitness");
           ...
           geneTable = (MutableTableImpl) this.pullInput(2);
           ...
           while(fitnessExecs == null) {
                fitnessExecs = (MutableTableImpl) this.pullInput(3);
            }
            ...
            if(geneTable == null){
                ...
                System.out.println("ERROR - GeneTable is null");
            }
	...
	public void callClusterExec () {//(NsgaPopulation popul) { //
          ...
          try {
            ...
            String nameOfMatlabScript = execName;
            Integer noFiles = new Integer(popTable.getNumRows()) ;
            Integer max = new Integer(noMaxClusters);
            Integer select = new Integer(pop.getNumIndivsForUserRanking());
       ...
       // public void writeGeneToFile (double [] indiv, String[] execInputFileNames) throws IOException {
        public void writeGeneToFile (String[] execInputFileNames) throws IOException {
            ...
            int temp1 = geneTable.getNumRows();
            int temp2 = totalNumOutFiles;
            System.out.println ("Gene Table Num Rows  " + temp1);
            System.out.println ("Total Num Out Files  " + temp2);
            String [][] interpFiles = new String [geneTable.getNumRows()][totalNumOutFiles];
             ...
             for (int i = 0; i < geneTable.getNumRows(); i++){
                 ...
                 for (int j=0; j< numOutputFiles.length; j++) {
                    ...
                    for (int k=0; k < numOutputFiles[j]; k++){
                        String dest = new String (execOutputFileNames[j][k]+"_"+"Ind"+ geneId.toString(geneTable.getInt(i,0)));
              ...
              for(int i = 0; i < totalNumOutFiles; i++){
                  String[] colDat = new String [geneTable.getNumRows()];
                  for (int j=0; j< geneTable.getNumRows(); j++){
              ...
              for (int ii = 0 ; ii < getNumFitnessExecs(); ii++) {
                try {
                   ...
                   if (execInputFileNames[ii] != null){
                        ...
                        pw.println(geneTable.getNumRows());
                        // write length of each gene/chromosome
                        pw.println(geneTable.getNumColumns()-1);
                        ...
                        for (int i = 0; i< geneTable.getNumRows(); i++) {
                            ...
                            double [] gene = new double [geneTable.getNumColumns() - 1];
                            for (int j=0; j<geneTable.getNumColumns()-1; j++){
                              gene[j] = geneTable.getDouble(i,j+1);
                            }
