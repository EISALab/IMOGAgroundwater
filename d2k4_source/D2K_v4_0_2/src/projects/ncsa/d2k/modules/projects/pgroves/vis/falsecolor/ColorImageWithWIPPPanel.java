...
public class ColorImageWithWIPPPanel extends ColorImagePanel{
	...
	*/
	public ColorImageWithWIPPPanel(Table img, FalseColorMap colorFunction, Table wellLocations){ //, int[] circleWellLocations){

		super(img, colorFunction, 1);
		...
		for(i=0; i < height; i++){
			for(j=0; j < width; j++){
				...
				colors = colorMap.getColorComponents(val);
                                ...
                                if((val == -5.555000)||(val == 905.555000)||(val == 5.55500)){
                                    colors[0] = 0;
                                    colors[1] = 0;
                                    colors[2] = 0;
                                }
