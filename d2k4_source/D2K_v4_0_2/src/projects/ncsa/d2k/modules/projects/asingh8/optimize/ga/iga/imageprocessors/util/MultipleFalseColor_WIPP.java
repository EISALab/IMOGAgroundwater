...
public class MultipleFalseColor_WIPP extends DataPrepModule implements java.io.Serializable {
                ...
                */
                ...
                for (int i=0; i< geneTable.getNumRows(); i++) {
                    ...
                    for (int k=0; k < interpFilenamesTable.getNumColumns(); k++){
                          ...
                          falseColPan [i][k] = new FalseColorPanel(interpTable, wells, 1);
                          falseColPan [i][k].imagePanel.setZoom(zoomLevel);
                          //, wells, selectedWells);
                          attributeGridDistrib = null;
                        }
                }
                
                //clean up manually and invoke the garbage collector
                interpTable = null;
                wells = null;
                geneTable = null;
                interpFilenamesTable = null;
