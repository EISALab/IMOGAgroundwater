package ncsa.d2k.modules.projects.mbabbar.optimize.ga.emo;
...
public class EvaluateExecutableFitness_BinaryInd extends ncsa.d2k.core.modules.ComputeModule{
        int numExecFitness;
	...
	*/
	...
	public String getModuleName() {
		return "EvaluateExecutableFitness_BinaryInd";
	}
	...
	*/
	...
	public void evaluateIndividual (Population popul) {//(NsgaPopulation popul) { //
            ...
            //MONumericIndividual[] ni = new MONumericIndividual[popul.size()] ;
              MOBinaryIndividual[] ni = new MOBinaryIndividual[popul.size()] ;
