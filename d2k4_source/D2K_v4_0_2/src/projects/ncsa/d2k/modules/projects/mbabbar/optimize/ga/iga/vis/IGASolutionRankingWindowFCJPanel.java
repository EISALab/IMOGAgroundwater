 ...
 */
public class IGASolutionRankingWindowFCJPanel extends UIModule {
...
////////////////////////////////////////////////////////////////////////////////
   ...
   public class IGARankingView extends JUserPane implements ActionListener   {
     ...
     // protected Table table = null;
      ...
      protected IGASolutionRankingWindowFCJPanel parent;
      /** Back button */
      ...
      public void initView(ViewModule mod) {
        ...
        parent = (IGASolutionRankingWindowFCJPanel)mod;
        createPicturesPanel();
                ...
                for (int i =0; i<4; i++){
                    ...
                    // add pictures to a grid panel
                     ...
                     ////////////////////////////////////////////////////////////////////
                      ...
                      pictureScrollPane[k][i].setMinimumSize (new Dimension (400, 250));
                      pictureScrollPane[k][i].setPreferredSize (new Dimension (400, 250));
