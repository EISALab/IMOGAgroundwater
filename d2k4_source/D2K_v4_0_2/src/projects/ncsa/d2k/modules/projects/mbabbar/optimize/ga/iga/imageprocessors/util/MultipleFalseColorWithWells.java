...
/**
	...
	@author mbabbar, adapted from FalseColorWithWells edited by pgroves
	@date 01/21/04
	*/

public class MultipleFalseColorWithWells extends DataPrepModule
                    ...
                    for (int k=0; k < interpFilenamesTable.getNumColumns(); k++){
                          ...
                          for (int m = 0; m< numGridCols; m++){
                            ...
                            for (int p = 0; p< numGridRows; p++){
                              attribCol[p] = attributeGridDistrib[p][m];
                            }
