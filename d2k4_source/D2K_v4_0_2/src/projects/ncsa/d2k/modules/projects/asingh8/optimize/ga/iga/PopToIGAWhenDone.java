...
/**
	...
	or fitness.
*/
public class PopToIGAWhenDone extends ncsa.d2k.core.modules.DataPrepModule {
	...
	*/
	public String getOutputInfo(int index) {
		switch (index) {
			case 0: return "The NSGA Population going for IMOGA";
                        case 1: return "The IGA NSGA Population going for MOGA";
                        case 2: return "This table just contains the objective values for each of the individuals in the first non-dominated front.   ";
	...
	*/
	public String[] getOutputTypes() {
		String[] types = {"ncsa.d2k.modules.projects.mbabbar.optimize.ga.iga.IGANsgaPopulation", "ncsa.d2k.modules.projects.mbabbar.optimize.ga.iga.IGANsgaPopulation",
