 ...
 */
public class IGASolutionRankingWindowFCJPanelVar extends UIModule {
...
////////////////////////////////////////////////////////////////////////////////
   ...
   public class IGARankingView extends JUserPane implements ActionListener   {
     ...
     // protected Table table = null;
      ...
      protected IGASolutionRankingWindowFCJPanelVar parent;
      /** Back button */
      ...
      public void initView(ViewModule mod) {
        ...
        parent = (IGASolutionRankingWindowFCJPanelVar)mod;
        createPicturesPanel();
            ...
            public void actionPerformed(ActionEvent e) {
              ...
              for (int m = 0; m < totalPics ; m++){
                  ...
                  for ( int n = 0; n < currentPop.getNumObjectives(); n++) {
                      if ( qualObjs[n] == true ){
                          double shift = ((double)currentPop.getCurrentGeneration() )/100;
                          nis.setObjective(n , ((double) rankIndivs[m]- shift) );
                      }
                  }
