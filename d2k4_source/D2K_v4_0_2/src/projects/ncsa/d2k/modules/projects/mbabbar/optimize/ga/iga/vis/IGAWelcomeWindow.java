 ...
 */
public class IGAWelcomeWindow extends UIModule {
...
////////////////////////////////////////////////////////////////////////////////
   ...
   public String getModuleInfo() {
      ...
      sb.append("This module welcomes users to the interactive session of the IGA");
      return sb.toString();
   }

   public String getModuleName() {
      return "IGA: Welcome Window";
   }
...
////////////////////////////////////////////////////////////////////////////////
    ...
    */
   public class IGAWelcomeView extends JUserPane implements ActionListener {

      /** a reference to our parent module */
      protected IGAWelcomeWindow parent;
      /** Next button */
      ...
      public void initView(ViewModule mod) {
         parent = (IGAWelcomeWindow)mod;
            ...
            next = new JButton("Start Session");
      ...
      public void setInput(Object input, int idx) {
            ...
            JLabel welcomelabel = new JLabel("Welcome to the Interactive Genetic Algorithm Session !");       // create a Label
