 ...
 */
public class IGASolutionRankingWindowFCJPanelVarShowAll extends UIModule {
...
////////////////////////////////////////////////////////////////////////////////
   ...
   public class IGARankingView extends JUserPane implements ActionListener   {
     ...
     // protected Table table = null;
      ...
      protected IGASolutionRankingWindowFCJPanelVarShowAll parent;
      /** Back button */
      ...
      public void initView(ViewModule mod) {
        ...
        parent = (IGASolutionRankingWindowFCJPanelVarShowAll)mod;
        createPicturesPanel();
      ...
      protected void createPicturesPanel( ) {
         ...
         for (int i =0; i < currentPop.size(); i++){
            if (currentPopTable.getBoolean(i,currentPopTable.getNumColumns()-2) == false){
                picIndivIds [j] = i;
                rankIndivs [j] = 3;
                j++;
            }
         ...
         next1.addActionListener(new AbstractAction() {
            public void actionPerformed(ActionEvent e) {
              ...
              for (int m = 0; m < totalPics ; m++){
                 ...
                 //for (int i =0; i < currentPopTable.getNumRows(); i++){
                  if (currentPopTable.getBoolean(picIndivIds[m],currentPopTable.getNumColumns()-2) == true){
             //   totalPics ++;
                 //}    
                    ...
                    // add pictures to a grid panel
                     ...
                     ////////////////////////////////////////////////////////////////////
                      for (int j=0; j< panelInTitle[0].length; j++){
                          int temp = currentPopTable.getInt(picIndivIds[counter],currentPopTable.getNumColumns()-1);
                          picgridTitlePanel.add(new JLabel(panelInTitle[picIndivIds[counter]][j]));
                      ...
                      for (int j=0; j< panelIn[0].length; j++){
                          FalseColorPanel fc = (FalseColorPanel)(panelIn[picIndivIds[counter]][j]);
