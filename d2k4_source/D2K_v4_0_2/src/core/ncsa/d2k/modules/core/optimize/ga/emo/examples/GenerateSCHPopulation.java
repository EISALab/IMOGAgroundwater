...
*/
public class GenerateSCHPopulation extends PopulationPrep  {
	...
	*/
	public void doit () throws Exception {
		...
		int numGenes = 1;
		DoubleRange [] xyz = new DoubleRange [1];
		xyz [0] = new DoubleRange ("x1", 1000.0, -1000.0);
