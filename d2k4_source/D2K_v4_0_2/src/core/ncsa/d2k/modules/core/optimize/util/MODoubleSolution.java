...
public class MODoubleSolution extends DoubleSolution implements MOSolution, java.io.Serializable {
         ...
         */
        public MODoubleSolution (DoubleRange [] ranges, 
                                 ObjectiveConstraints [] oc, int numConstr) {
                super (ranges, numConstr);
                objectiveConstraints = oc;
                objectives = new double [oc.length];
        }

        public MODoubleSolution (DoubleRange [] ranges, 
                                 ObjectiveConstraints [] oc, int numConstr, long randomSeed) {
                super (ranges, numConstr, randomSeed);
                objectiveConstraints = oc;
                objectives = new double [oc.length];
        }
